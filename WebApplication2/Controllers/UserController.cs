...
namespace WebApplication2.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(AvtoStrachovanieDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> GetUser(int id)
        {
            ...
            if (user == null)
            {
                return NotFound($"No uses with ID {id}"); // 404 Not Found
            }
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
            ...
            {
                return Conflict($"A user with ID {user.Id} already exists."); // 409 Conflict
            }
